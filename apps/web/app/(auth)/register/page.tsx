      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="space-y-3">
          <a
            ...
            className="flex w-full items-center justify-center gap-3 rounded-md border border-border bg-background px-4 py-2.5 text-sm font-medium transition-colors hover:bg-accent"
          >
        ...
        <form action="/api/auth/register" method="POST" className="space-y-4">
          ...
          <button
            ...
            type="submit"
            className="flex w-full justify-center rounded-md bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground shadow-sm hover:bg-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-ring"
          >
            Create Account
          </button>
        </form>
